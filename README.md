...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xzau28.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xzau28.containers.anotherwebservice.com/
...
```
git clone git@github.com:khushveer007/container-xzau28.git
cd container-xzau28
```
...
```
docker attach container-xzau28
```
